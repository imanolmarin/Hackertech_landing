...
const rooms = [
    ...
    { name: 'Fraud War', icon: ShieldAlert, logo: '/assets/logo_png_transparente.png', desc: 'Ingresá a una simulación de war room antifraude. Investigá eventos que parecen aislados y descubrí la campaña coordinada detrás. Analizá logs, dispositivos e IPs, ejecutá consultas SQL y diseñá reglas defensivas mientras el atacante adapta su estrategia en tiempo real. Una experiencia donde la ciberseguridad, el análisis de datos y la toma de decisiones se ponen a prueba. Presentado por BANCOR', color: '#f97316', color2: '#16a34a' },
];
